        ...
        <div class="main-panel">
            <div class="content-wrapper">
                <div class="page-header">
                    <h3 class="page-title">Be updated</h3>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-sm-flex align-items-center mb-4">
                                    <h4 class="card-title mb-sm-0">View public notices</h4>
                                    ...
                                    <table class="table">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="font-weight-bold">Notice type</th>
                                            ...
                                            if ($query->rowCount() > 0) {
                                                foreach ($results as $row) { ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?php echo htmlentities($row->Foruser); ?>
                                                        </td>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <a target="blank"
                                                                href="readnotice.php?noticeid=<?php echo htmlentities($row->ID); ?>"
